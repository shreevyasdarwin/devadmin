...
$price = $_POST['price'];
$baseimg = 'uploads/' . $_FILES['img']['name'];
$img = move_uploaded_file($_FILES['img']['tmp_name'], $baseimg);
    if($img)
    {
        $sql= "insert into package (p_name,p_img,p_state,p_country,p_price,status) values ('$name','$baseimg','$state','$country','$price','1')";
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="block">
                            ...
                            <form method="POST" action="addpackage2.php" enctype="multipart/form-data" class="form-horizontal form-bordered">
                                ...
                                <div class="form-group form-actions">
                                    <div class="col-md-9 col-md-offset-3">
                                        <input id="submit" name="submit" class="btn btn-sm btn-primary" value="Submit">
                                    </div>
                                </div>
                            </form>
...
<script>
    $('#submit').click(function () {
        ...
        var button = 'addpackage';
        form_data.append('file', file_data);  // Append all element in FormData  object
        form_data.append('addpackage',button);
        console.log(form_data);
        $.ajax({
            url         : 'addpackage2.php',         // what to expect back from the PHP script, if anything
            cache       : false,
            // contentType : false,
