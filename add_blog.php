...
if(isset($_POST['upload'])){
    ...
    if(move_uploaded_file($_FILES['img']['tmp_name'], $target)){
        $add = mysqli_query($con, "INSERT INTO blog (img,title,content,created_date,status) VALUES ('$img','$title','$content',CURDATE(),1)");
        if($add){
            $notify = true;
        }
    }
                            ...
                            <form enctype="multipart/form-data" method="POST" action="" class="form-horizontal form-bordered">
                                ...
                                <div class="form-group form-actions">
                                    <div class="col-md-9 col-md-offset-3">
                                        <button name="upload" type="submit" class="btn btn-sm btn-primary"><i class="fa fa-angle-right"></i> Upload blog</button>
                                    </div>
                                </div>
                            </form>
