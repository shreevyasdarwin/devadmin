...
$user = mysqli_query($con,"SELECT * FROM blog ORDER BY created_date DESC");
?>
<!DOCTYPE html>
                        ...
                        <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                            ...
                            while($row=mysqli_fetch_array($user))
                            {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><img src="blog_img/<?php echo $row['img']; ?>" style="height: 150px; width: 150px;" class="img-circle" alt=""></td>
                                    <td class="text-center"><?php echo $row['title']; ?></td>
                                    <td class="text-center"><?php echo mb_strimwidth($row['content'], 0, 500,"...read more"); ?></td>
                                    <td class="text-center"><?php echo $new_date; ?></td>
                                    <td class="text-center"><a href="edit_blog.php?id=<?php echo $row['id']; ?>"><i class="fa fa-pencil-square-o" style="font-size: 20px;"></i></a></td>
