...
$book = mysqli_query($con,"SELECT hc.*,bd.appReference,CONCAT(u.fname,' ',u.lname) as fullname FROM hotel_cancel_booking AS hc INNER JOIN user_details AS u ON hc.user_id=u.id INNER JOIN booking_details AS bd ON bd.appReference=hc.app WHERE hc.status='0' ORDER BY created_date DESC");
            ...
            <div id="page-content">
                ...
                <div class="content-header">
                    <div class="header-section">
                        <h1>
                            <i class="fa fa-table"></i>Cancelled Hotel Booking's
                        </h1>
                    </div>
                </div>
                <ul class="breadcrumb breadcrumb-top">
                    <li>Dashboard</li>
                    <li><a href="">Cancelled Hotel Booking's</a></li>
                </ul>
                    ...
                    <div class="table-responsive">
                        <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                            ...
                            <tr>
                                ...
                                <th class="text-center">Cancel charges</th>
                                <th class="text-center">Refund amount</th>
                                <th class="text-center">Change request id</th>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="text-center">
                                        <?php if($row['refund_amt'] != 0){
                                            ...
                                            ?>
                                            <?php
                                            echo "<button type='submit' id='cancelreject$cnt' class='btn btn-sm btn-danger' value='".$row['id']."' name='reject'>Reject</button>";
                                             } else{
                                            echo '<h3 class="label label-danger" ">Non-Refundable Booking</h3>';
                                            } ?>
                                    </td>
                                </tr>
                            <?php } ?>
    ...
    <script>
        ...
        $('#cancelreject<?= $cnt; ?>').click(function () {
            ...
            $.ajax({
                url: "ajax.php",
                method: "POST",
                data: {action: 'cancelreject', id: id},
                success: function (data) {
