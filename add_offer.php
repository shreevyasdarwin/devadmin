...
if(isset($_POST['upload'])){
    ...
    if(move_uploaded_file($_FILES['img']['tmp_name'], $target)){
        $add = mysqli_query($con, "INSERT INTO top_offers (title,image,description,validity,created_date,status) VALUES ('$title','$img','$content','$expdate',CURDATE(),1)");
        if($add){
            $notify = true;
        }
        else{
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="block">
                            ...
                            <div class="block-title">
                                ...
                                <h2><strong>Add blogs</strong> Form</h2>
                            </div>
                            <!-- END Form Elements Title -->

                            <!-- Basic Form Elements Content -->
                            <form enctype="multipart/form-data" method="POST" action="" class="form-horizontal form-bordered">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="example-text-input">Uplodad blog image</label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea id="textarea-ckeditor" name="content" class="ckeditor" placeholder="Content goes here..."></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="example-text-input">Offer validity</label>
                                    <div class="col-md-9">
                                        <input type="text" id="example-datepicker2" name="expdate" class="form-control input-datepicker" data-date-format="dd-mm-yy" value="<?php echo date("d/m/y"); ?>">
                                    </div>
                                </div>
                                <div class="form-group form-actions">
                                    <div class="col-md-9 col-md-offset-3">
                                        <button name="upload" type="submit" class="btn btn-sm btn-primary"><i class="fa fa-angle-right"></i> Add offer</button>
                                    </div>
                                </div>
                            </form>
