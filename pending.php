...
$book = mysqli_query($con,"SELECT CONCAT(u.fname,' ',u.lname) as fullname,p.* FROM payment_refund AS p INNER JOIN user_details AS u ON u.user_id=p.user_id WHERE p.service = 'flight' AND p.status='0'");
