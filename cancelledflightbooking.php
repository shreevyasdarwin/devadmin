...
$book = mysqli_query($con,'SELECT u.fname,u.lname,b.type,b.appReference,b.amount,b.airline,b.flight_no,b.cabinclass,b.booking_date FROM booking_details AS b INNER JOIN user_details AS u ON b.id=u.user_id WHERE b.type=1 AND b.status=1 ORDER BY booking_date DESC');
?>
<!DOCTYPE html>
        ...
        <div id="main-container">
            ...
            <div id="page-content">
                ...
                <ul class="breadcrumb breadcrumb-top">
                    <li>Tables</li>
                    <li><a href="">Manage Flight Bookings</a></li>
                </ul>
