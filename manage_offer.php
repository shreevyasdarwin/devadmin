...
$user = mysqli_query($con,"SELECT * FROM top_offers ORDER BY created_date DESC");
?>
<!DOCTYPE html>
                        ...
                        <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                            ...
                            while($row=mysqli_fetch_array($user))
                            {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><img src="offer_img/<?php echo $row['image']; ?>" style="height: 150px; width: 150px;" class="img-circle" alt=""></td>
                                    <td class="text-center"><?php echo mb_strimwidth($row['description'], 0, 500,"...read more"); ?></td>
                                    <td class="text-center"><?php echo $row['validity']; ?></td>
                                    <td class="text-center"><?php echo $new_date; ?></td>
                                    <td class="text-center"><a href="edit_offer.php?id=<?php echo $row['id']; ?>"><i class="fa fa-pencil-square-o" style="font-size: 20px;"></i></a></td>
