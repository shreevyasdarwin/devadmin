...
if(isset($_POST['upload'])){
    ...
    if($img  != '')
    {
        ...
        if(move_uploaded_file($_FILES['img']['tmp_name'], $target)){
            unlink($previmg);
            $add = mysqli_query($con, "UPDATE coupons SET title='$title',image='$img',description='$description',coupon_code='$code',discount_amt='$amt',expiry_date='$expdate',updated_date=CURDATE() WHERE id='$id'");
            if($add){
                $notify = true;
            }
            else{
    ...
    {
        $add = mysqli_query($con, "UPDATE coupons SET title='$title',description='$description',coupon_code='$code',discount_amt='$amt',expiry_date='$expdate',updated_date=CURDATE() WHERE id='$id'");
            if($add){
                $notify = true;
            }
            else{
