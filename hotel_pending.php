...
$book = mysqli_query($con,"SELECT CONCAT(u.fname,' ',u.lname) as fullname,p.* FROM payment_refund AS p INNER JOIN user_details AS u ON u.user_id=p.user_id WHERE p.service = 'hotel' AND p.status='0'");
            ...
            <div id="page-content">
                ...
                <div class="content-header">
                    <div class="header-section">
                        <h1>
                            <i class="fa fa-table"></i>Pending Hotel Booking's
                        </h1>
                    </div>
                </div>
                <ul class="breadcrumb breadcrumb-top">
                    <li>Dashboard</li>
                    <li><a href="">Pending Hotel Booking's</a></li>
                </ul>
